/* https://medium.com/nerd-for-tech/what-is-the-difference-between-react-router-and-conventional-routing-9b11159d92a4*/
...
export default function About() {
  ...
  return (
    ...
    <button type="button" onClick={togggleStyle} className="btn btn-primary my-3">{btnText}</button>
    </div>
  )
}
